...
set EnginePath=D:\Programm\UnrealEngine\UE_5.4
set VersionSelector=D:\Programm\Epic Games\Launcher\Engine\Binaries\Win64\UnrealVersionSelector.exe
...
set ProjectPureName=Sandbox_Prototype
...
set COPYRIGHT_LINE=// Copyright Nexus Studio. All Rights Reserved.
